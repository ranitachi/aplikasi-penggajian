...
class karyawanTetapController extends Controller
{
    ...
    {
        $data = Karyawan::all()->where('status_kerja',1);
        return view('pages.karyawanTetap.index',compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $datas->status_kerja = 1;
        $datas->flag = $request->flag;
        $datas->save();
        return redirect()->route('karyawan-tetap.index')->with('alert-success','Berhasil Menambahkan Data Pegawai!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $datas->flag = $request->flag;
        $datas->save();
        return redirect()->route('karyawan-tetap.index')->with('alert-success','Berhasil Mengupdate Data Pegawai!');
    }
    ...
    public function destroy($id)
    {
        ...
        $data->flag = 0;
        $data->save();
        return redirect()->route('karyawan-tetap.index')->with('alert-success','Berhasil Menghapus!');
    }
}
